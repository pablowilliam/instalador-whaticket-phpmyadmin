...
```bash
sudo apt install -y git && git clone https://github.com/pablowilliam/instalador-whaticket-phpmyadmin/instalador.git instalador && sudo chmod -R 777 ./instalador && cd ./instalador && sudo ./install_primaria
```
